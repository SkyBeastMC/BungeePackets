...
public enum Material
{
	...
	private static final Pattern SPACE_FINDER = Pattern.compile("\\s+");
	private static final Pattern SPECIAL_FINDER = Pattern.compile("\\W");
	...
	static
	{
		...
		BY_ID = new HashMap<>(values);
		BY_NAME = new HashMap<>(values);
	...
	public static Material matchMaterial(@NonNull String name)
	{
		try
		{
			return getMaterial(Integer.parseInt(name));
		}
		catch (NumberFormatException ignored) {}

		String filtered = name.toUpperCase();

		filtered = SPECIAL_FINDER.matcher(SPACE_FINDER.matcher(filtered).replaceAll("_")).replaceAll("");
